...
#In addition, in version 4.1, only the xx yy and zz strains will be considered
# (voigstrains[1:3])
...
cd("C:\\Users\\Hugo\\Desktop\\optim\\V4\V4.1")
...
#lay = 9
    ...
    while conv_cont < 2
        ...
        for i = 1:num_elements_layer
            ...
            Dr = DrMatrix(pois)
            strains = voigtstrains_el2[iel][1:3]
        ...
        PrintParaview(v_nodes, v_mesh, strains_nod2, stresses_nod2, u, E2_nodes, "StiffEvolV41_layer$(lay)_$loop2.vtu")
    ...
    E2_nodes = NodalYoungModule(nodal_connectivity, Eold2_mesh)
    PrintParaview(v_nodes, v_mesh, strains_nod2, stresses_nod2, u, E2_nodes, "OptimResultsV41_layer$(lay)($(loop2-1)).vtu")
