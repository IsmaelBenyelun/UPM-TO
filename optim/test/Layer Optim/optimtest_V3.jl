...
cd("C:\\Users\\Hugo\\Desktop\\optim\\V3")
...
#lay = 7
    ...
    while conv_cont < 2
        ...
        PrintParaview(v_nodes, v_mesh, strains_nod2, stresses_nod2, u, E2_nodes, "StiffEvolV3_layer$(lay)_$loop2.vtu")
    ...
    E2_nodes = NodalYoungModule(nodal_connectivity, Eold2_mesh)
    PrintParaview(v_nodes, v_mesh, strains_nod2, stresses_nod2, u, E2_nodes, "OptimResultsV3_layer$(lay)($(loop2-1)).vtu")

end #layers loop

E2_mesh = copy(Eold2_mesh)
(voigtstrains_el2, voigtstresses_el2, strains_nod2, stresses_nod2) =
