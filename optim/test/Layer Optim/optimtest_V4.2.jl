...
In version 4.2. we are going to stablish a maximum stiffess value with which
elements can update their stiffness
=#
...
cd("C:\\Users\\Hugo\\Desktop\\optim\\V4\\V4.2")
...
#lay = 9
    ...
    while conv_cont < 2
        ...
        PrintParaview(v_nodes, v_mesh, strains_nod2, stresses_nod2, u, E2_nodes, "StiffEvolV42_layer$(lay)_$loop2.vtu")
    ...
    E2_nodes = NodalYoungModule(nodal_connectivity, Eold2_mesh)
    PrintParaview(v_nodes, v_mesh, strains_nod2, stresses_nod2, u, E2_nodes, "OptimResultsV42_layer$(lay)($(loop2-1)).vtu")
