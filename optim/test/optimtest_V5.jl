...
cd("C:\\Users\\Hugo\\Desktop\\optim\\V5")
...
while conv_cont < 2
    ...
    PrintParaview(v_nodes, v_mesh, strains_nod2, stresses_nod2, u, E2_nodes, "StiffEvolV5_$loop2.vtu")
...
E2_nodes = NodalYoungModule(nodal_connectivity, Eold2_mesh)
PrintParaview(v_nodes, v_mesh, strains_nod2, stresses_nod2, u, E2_nodes, "OptimResultsV5($(loop2)).vtu")
